document.addEventListener("DOMContentLoaded", function(event) {
        $(document).ready(function(){
            ...
            $("#trackinghistoryarea").hide();
			$("#customerphonearea").hide();

            $('#Talk-Hub-Choice').change(function(){
			if($(this).val().length == 0) {
				$("#trackinghistoryarea").hide();
				$("#customerphonearea").hide();
     			}
	     
     			if($(this).val()=="Tracking History") {
				$("#trackinghistoryarea").fadeIn();
				$("#customerphonearea").hide();
     			}
			
     			if($(this).val()=="Customer Phone") {
				$("#trackinghistoryarea").hide();
				$("#customerphonearea").fadeIn();
			}
		});
...
function tracknumber(){
    ...
    document.getElementById("loading").style.display = 'inline';
                    ...
                    request.onreadystatechange = function () {
                        if (this.readyState === 4) {
                            ...
                            if(json_responsejd.message = "Successful"){
                                ...
                                document.getElementById("jobdescription").innerHTML = json_responsejd.data[0].job_description;
                                document.getElementById("orderid").innerHTML = json_responsejd.data[0].order_id;
        ...
        document.getElementById("trackphonebutton").addEventListener("click", trackphonenumber);
    
        function trackphonenumber(){
    
            document.getElementById("trackingphonearea").style.display = 'none';
            ...
            document.getElementById("wrongphoneinput").style.display = 'none';
            document.getElementById("loadingphone").style.display = 'inline';
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    console.log('Headers:', this.getAllResponseHeaders());
                    console.log('Body:', this.responseText);
                    responsepn = this.responseText;
                    json_responsepn = JSON.parse(responsepn);
    
                    if(json_responsepn.status != 404){
                        if(json_responsepn.data[0].Name.value != ""){
                            document.getElementById("loadingphone").style.display = 'none';
    
                            document.getElementById("customerresultbox").style.display = 'block';
    
                            document.getElementById("customername").innerHTML = json_responsepn.data[0].Name;
                            document.getElementById("phonenumber").innerHTML = json_responsepn.data[0].Phone;
                            document.getElementById("customeremail").innerHTML = json_responsepn.data[0].Email;
                            document.getElementById("customeraddress").innerHTML = json_responsepn.data[0].address;
                            document.getElementById("customerid").innerHTML = json_responsepn.data[0].customer_id;
    
                            document.getElementById("trackphoneagain").style.display = 'block';
    
                            document.getElementById("trackphonebuttonagain").addEventListener("click", function(){
                                document.getElementById("trackphoneagain").style.display = 'none';
                                document.getElementById("trackingphonearea").style.display = 'block';
                                document.getElementById("customerresultbox").style.display = 'none';
                            });
                        } 
                    }
                    ...
                    if (json_responsepn.status == 404){
                        document.getElementById("loadingphone").style.display = 'none';
                        document.getElementById("wrongphoneinput").style.display = 'block';
                        document.getElementById("trackingphonearea").style.display = 'block';
                    }
                    }
                };
